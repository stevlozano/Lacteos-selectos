...
export function MobileCart() {
  ...
  return (
    <>
      {/* Botón en navbar superior */}
      {!isOpen && (
        <button
          onClick={() => setIsOpen(true)}
          className="lg:hidden fixed top-16 right-4 z-50 bg-black text-white w-12 h-12 rounded-full shadow-lg flex flex-col items-center justify-center hover:bg-neutral-800 transition-all active:scale-95"
        >
