...
export default function ResetPassword() {
  ...
  useEffect(() => {
    // Check if we have a valid session/token from the password reset email
      ...
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-black p-4">
        <div className="w-full max-w-md text-center">
          ...
          <Link
            ...
            className="inline-block bg-black dark:bg-white text-white dark:text-black py-3 px-6 
                       font-light tracking-wide hover:bg-neutral-800 dark:hover:bg-neutral-200 transition-colors"
          >
