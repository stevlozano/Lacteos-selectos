            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <button
                  ...
                  className="border border-neutral-300 dark:border-neutral-600 py-3 px-2 text-xs hover:border-black hover:bg-neutral-50 dark:hover:bg-neutral-700 flex flex-col items-center justify-center gap-1.5 disabled:opacity-50 dark:text-white transition-colors"
                >
                  {isGettingLocation ? (
                    <>
                ...
                <button
                  ...
                  className="border border-neutral-300 dark:border-neutral-600 py-3 px-2 text-xs hover:border-black hover:bg-neutral-50 dark:hover:bg-neutral-700 flex flex-col items-center justify-center gap-1.5 dark:text-white transition-colors"
                >
              ...
              <input
                ...
                className="w-full border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-xs focus:border-black dark:focus:border-white focus:outline-none bg-white dark:bg-neutral-700 text-black dark:text-white placeholder:text-neutral-400 dark:placeholder:text-neutral-500"
              />
